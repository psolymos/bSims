...
- Addressing CRAN requirements using title case and removing redirected
  URLs.

## Version 0.3-1, 2024-05-20

- Better print method for `bsims_all`
  ([\#18](https://github.com/psolymos/bSims/issues/18)).
...
- Added singing direction related anisotropy to detection and
  transcription.
...
- Added tutorial as vignette
  ([\#10](https://github.com/psolymos/bSims/issues/10)).
- Added `run_app` to run Shiny apps.
- Added `estimate` method to fit simple models and estimate density.

## Version 0.1-3, 2019-09-18

- Incorporated feedback (GitHub issues
  [\#1](https://github.com/psolymos/bSims/issues/1)-8).
